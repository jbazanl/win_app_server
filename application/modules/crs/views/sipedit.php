...
<!--                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-6 col-xs-12">
                            <div class="radio">
                                <label><input type="radio" name="status" id="status1" value="1"  <?php if ($account_id_sip_data['status'] == 1) { ?> checked="checked" <?php } ?>  onclick="return false;" /> Active</label>
                            </div>  
                            <div class="radio">
                                <label> <input type="radio" name="status" id="status0" value="0" <?php if ($account_id_sip_data['status'] == 0) { ?> checked="checked" <?php } ?>  onclick="return false;" /> Inactive</label>
                            </div>
